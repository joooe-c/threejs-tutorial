...
import BlueCar from '../Assets/Models/blue_car.glb'
...
class CubeEnvironment extends Component {
    ...
    constructor(props) {
		...
		this.overlayItem = new OverlayItem(
			"4:44", 
			"VIDEO", 
			"https://www.youtube.com/embed/zSkA61esq_c"
		)
      }
	...
	populateScene = () => {
		...
		this.addModel(BlueCar, new THREE.Vector3(0,0,0), this.overlayItem);
		this.setupFog();
	};
	...
	setupCamera = () => {
		...
		this.camera.position.z = 75; // is used here to set some distance from a cube that is located at z = 0
	};
